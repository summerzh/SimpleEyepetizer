package com.gyt.eyepetizer.widget;
...
public class MultiStateView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        int noNetworkViewResId = a.getResourceId(R.styleable.MultiStateView_msv_noNetworkView, -1);
    ...
    private boolean isValidContentView(View view) {
        ...
        return view != mLoadingView && view != mErrorView && view != mEmptyView && view != mNoNetworkView;
    }
